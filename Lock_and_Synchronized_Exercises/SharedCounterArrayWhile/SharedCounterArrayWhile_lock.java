 ...
 * with ReentrantLock to safely update a shared array, with threads running 
 ...
 * a `ReentrantLock` to synchronize access to the shared `n` counter and the array.
 */

public class SharedCounterArrayWhile_lock {
