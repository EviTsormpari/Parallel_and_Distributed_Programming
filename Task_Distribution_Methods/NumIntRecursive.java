...
* of the function f(x) = 4 / (1 + x^2) over the interval [0, 1]. 
* It applies a recursive divide-and-conquer strategy using threads, 
* where the work is split into smaller tasks until a defined threshold (limit)
* is reached, at which point each task is computed directly.
*/
